...
export const LEGAL_LIBRARY_ENTRIES: LegalLibraryEntry[] = [
  ...
  {
    id: 'magok-plan',
    title: '마곡일반산업단지 관리기본계획 변경 고시(서울특별시고시 제2026-144호)',
    effectiveDate: '2026-03-19',
    summary:
      '마곡 산업시설구역, 지식산업센터, 예외 심의, 제조시설 조건, 입주계약·임대 제한까지 실제 운영 기준으로 좁혀 주는 최신 핵심 문서입니다.',
    applicability:
      '산업시설구역 특화 업종, 지식산업센터 예외 허용, 융복합 심의, 제조시설 상한, 입주 후 계약·임대 제한을 읽을 때 직접 근거로 사용합니다.',
    ...
    officialSource: {
      title: '서울특별시 고시문 PDF',
      url: 'https://news.seoul.go.kr/citybuild/files/2026/03/69bb7f7919dfe6.72440696.pdf',
      authority: '서울특별시',
      publishedDate: '2026-03-19',
      documentNumber: '서울특별시고시 제2026-144호',
      description:
        '서울시 관리기본계획 카테고리에 게시된 최신 마곡일반산업단지 관리기본계획 변경 고시 원문 PDF입니다. 실제 페이지 번호와 별표를 그대로 확인할 수 있습니다.',
    },
    supplementarySources: [
      {
        title: '서울특별시 관리기본계획 게시 페이지',
        url: 'https://news.seoul.go.kr/citybuild/archives/534518',
        authority: '서울특별시 도시공간본부',
        publishedDate: '2026-03-19',
        documentNumber: '서울특별시고시 제2026-144호',
        description:
          '서울특별시 관리기본계획 게시 페이지로, 고시 개요와 첨부 원문 파일을 함께 확인할 수 있습니다.',
      },
    ],
  },
]
